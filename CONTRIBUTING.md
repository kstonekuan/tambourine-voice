...
- Prefer **typed variants over string literals** when the set of valid values is known—use `enum` in Rust, `StrEnum` in Python, and union types in TypeScript (e.g., `"toggle" | "hold"`)
